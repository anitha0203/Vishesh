  ...
  return (
    <Container fluid className="principlesp-container">
      ...
      <Row className="principles-Row">
        <Col className="principles-Col"><Image src={image1} className="icon" />
        ...
        <Col className="principles-Col"><Image src={image2} className="icon" />
        ...
        <Col className="principles-Col"><Image src={image3} className="icon" />
      ...
      <Row className="principles-Row">
        <Col className="principles-Col"><Image src={image4} className="icon" />
        ...
        <Col className="principles-Col"><Image src={image5} className="icon" />
        ...
        <Col className="principles-Col"><Image src={image6} className="icon" />
